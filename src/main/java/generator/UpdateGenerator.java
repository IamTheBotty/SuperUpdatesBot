...
public class UpdateGenerator {
    ...
    private String[] main = {"Мы ожидаем приход денег на день позже - завтра."
            ...
            , "Банковский день уже заканчивается, поэтому имейте в виду, что с большой вероятностью на карточках у вас они окажутся завтра. И завтра же я смогу вам детальнее рассказать про оставшиеся платежи."
